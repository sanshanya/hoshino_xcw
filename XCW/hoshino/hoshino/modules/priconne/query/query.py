...
p4 = R.img('priconne/quick/前卫.png').cqcode
p5 = R.img('priconne/quick/中卫.png').cqcode
p6 = R.img('priconne/quick/后卫.png').cqcode
p7 = R.img('priconne/quick/国服.png').cqcode
...
async def rank_sheet(bot, ev):
    ...
    if is_jp:
        msg.append('※不定期搬运自图中群号\n※图中广告为原作者推广，与本bot无关\日服本月中旬 rank表：')
        pos = match.group(3)
